...
[
  {{
    ...
    "link": "URL ÚNICA, DIRETA E ESPECÍFICA PARA A PÁGINA DE INSCRIÇÃO DO CURSO (PROIBIDO enviar links genéricos como coursera.org ou ev.org.br)",
    "categoria": "{topico['categoria']}",
    "tags": ["tag1", "tag2", "tag3"],
...
IMPORTANTE:
- CRÍTICO: O "link" DEVE ser a URL exata da página do curso. Links para a homepage da plataforma resultarão em falha na validação.
